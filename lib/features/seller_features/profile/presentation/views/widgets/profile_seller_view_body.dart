...
class ProfileSellerViewBody extends StatefulWidget {
  const ProfileSellerViewBody({super.key});

  @override
  State<ProfileSellerViewBody> createState() => _ProfileSellerViewBodyState();
}

class _ProfileSellerViewBodyState extends State<ProfileSellerViewBody> {
  @override
  void initState() {
