...
class CustomMultiSelectDialogFieldAddCoupon extends StatelessWidget {
  const CustomMultiSelectDialogFieldAddCoupon({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: MultiSelectDialogField<int>(
        ...
        onSaved: (newValue) {
          BlocProvider.of<AddCouponCubit>(context).products =
              newValue!;
        },
